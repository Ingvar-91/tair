var Charactiristics = (function ($) {
    ...
    //при нажатии на checkbox магазина, получить список характеристик
    $("body").on('click', 'input[name="shop_id"]', function () {
        var shop_id = $(this).val(),
            category_id = $('input[name="category_id"]:radio:checked').val();
    ...
    $("body").on('click', 'input[name="category_id"]', function () {
        var category_id = $(this).val(),
            shop_id = $('input[name="shop_id"]:radio:checked').val();
        ...
        if(category_id && shop_id){
            ...
            function (name) {
                ...
                $.ajax({
                    ...
                    url: '/admin/characteristics-name/add',
                    type: 'POST',
                    data: {
                    ...
                    success: function (data) {
                        ...
                        else showPNotify('error', 'Ошибка', 'Ошибка при добавлении данных');
                    }
                });
            });
        }
    ...
    $("#remove-characteristics-name").on('click', function(){
        ...
        if(ids.length){
            $.ajax({
                ...
                url: '/admin/characteristics-name/remove',
                type: 'DELETE',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    ids: ids
        ...
        if(id){
            ...
            function (name) {
                ...
                $.ajax({
                    ...
                    url: '/admin/characteristics-name/edit',
                    type: 'PUT',
                    data: {
                        _token: $('meta[name="csrf-token"]').attr('content'),
                        name: name,
    ...
    function getCharName(category_id){
        ...
        $.ajax({
            ...
            url: '/admin/characteristics-name/',
            type: 'GET',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content'),
                category_id: category_id,
