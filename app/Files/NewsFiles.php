...
trait NewsFiles{
    ...
    private function uploadPreviewNews($file){
        $fileNames = '';
        $folder = config('filesystems.news');
        ...
        $uploadedImageName = '';//путь и наименование изображения
    ...
    private function removeImagesProduct($file){
