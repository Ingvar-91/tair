...
<!-- products -->
<script src="/js/site/vendor-products.js"></script>
...
<!-- chars -->
<script src="/js/site/chars.js"></script>
...
<section class="box box-control m-b-0">
    {!! Breadcrumbs::render('vendor.products.edit.form', $product) !!}
</section>

<section id="products-vendor-edit" class="m">
    <form id="product-form" autocomplete="off" method="post" enctype="multipart/form-data" action="{{Route('vendor.products.edit', ['shop_id' => $shop->id])}}">
        <div class="row custom-row">
            <div class="col-sm-8">
                <div class="box p">
                    ...
                    <section>
                        ...
                        <input name="shop_id" type="hidden" id="shop_id" value="{{request()->shop_id}}"/>
            ...
            <div class="col-sm-4 m-t-sm">
                ...
                <div class="box p-l p-r">
                    ...
                    @include('site/vendor-products/publish', ['actionName' => 'Обновить', 'idName' => 'edit-submit'])
                </div>
