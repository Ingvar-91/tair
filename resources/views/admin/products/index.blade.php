        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="row">
					...
					<div class="col-md-2">
                        <div class="form-group">
							<label>Удаленные товары</label>
                            <select id="date_remove" name="date_remove" class="form-control">
...
<script>
    ...
    var dataTableAdditionalData = [
        ...
        {name: 'date_remove', value: document.getElementById('date_remove').options[document.getElementById('date_remove').selectedIndex].value}
    ];
</script>
